 ...
 *
 * The pure (framework-free) quantum math lives in `@/src/lib/quantum` and is
 * re-exported below so existing call sites of this module keep working. This
 * file retains only the THREE.js-dependent rendering helpers. Do NOT duplicate
 * any quantum formula here — each lives once in `lib/quantum`.
 */
...
// ── Re-exported pure quantum math (single source of truth) ──────────
// These previously lived in this file; they now live in lib/quantum.
export {
  stateVectorToBloch,
