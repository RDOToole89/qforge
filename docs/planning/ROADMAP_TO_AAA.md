...
*   **Tasks**:
    ...
    *   [ ] **Pydantic Validation**: Ensure all inputs to the `Engine` are validated via Pydantic models *before* execution starts.
...
*   **Objective**: Explain *why* we are doing this, not just *how*.
*   **Tasks**:
