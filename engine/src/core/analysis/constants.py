...
EEC_PERMUTATION_N: Final[int] = 1000
"""Default number of permutations for EEC significance test."""

EEC_SIGNIFICANCE_ALPHA: Final[float] = 0.05
"""Significance threshold for EEC permutation test."""
