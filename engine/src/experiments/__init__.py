...
from src.experiments.topology_comparison import (
...
EXPERIMENT_REGISTRY: dict[str, ExperimentProgram] = {
    ...
    # Balanced topology comparison (hypothesis hardening)
    "balanced_topology": balanced_topology,
}
