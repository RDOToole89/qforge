...
class ExperimentRunner:
    ...
    def run_experiment(
        ...
        noise_model = self._apply_noise(
            noise_enabled, noise_type, num_qubits, error_rate,
            z_prob, i_prob, t1, t2, sim_mode
        )
        ...
        result_data = self._run_simulation(circuit_compiled, backend, shots, noise_model, sim_mode)
