...
class GHZState(BaseState):
    ...
    def get_theoretical_properties(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "mermin_inequality_violation": 2**(self.num_qubits/2) if self.num_qubits > 2 else "n/a",
    ...
    def get_research_context(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "research_metrics": {
                ...
                "secondary": ["EEC (Entanglement-Error Correlation)", "TPS (Temporal Pathway Stability)"]
            },
            "control_comparisons": {
    ...
    def __str__(self) -> str:
        ...
        if self.num_qubits == 1:
            return f"GHZ(1 qubit) = |0⟩ [no entanglement]"
        else:
