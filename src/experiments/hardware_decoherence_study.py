...
Usage:
    ...
    python -m src.experiments.hardware_decoherence_study --mode hardware

    # Run same experiments in simulation (for comparison)
    python -m src.experiments.hardware_decoherence_study --mode simulation

    # Run a single experiment
    python -m src.experiments.hardware_decoherence_study --mode hardware --experiment basis
"""
