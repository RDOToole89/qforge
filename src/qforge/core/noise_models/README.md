...
come from the shared `src/qforge/core/math/` primitives (single source of truth).
...
from qforge.core.noise_models.noise_factory import create_noise_model
...
```python
from qforge.core.noise_models.noise_factory import create_noise_model, create_noise_instance
...
from qforge.core.noise_models.noise_factory import create_noise_model_for_hardware
