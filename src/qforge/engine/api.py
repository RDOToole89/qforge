...
# Version helper
from qforge.engine._version_util import get_version

# Analysis integration (counts canonicalization + metrics bundle)
from qforge.engine.analysis import compute_metrics_bundle, extract_counts_from_result

# App plumbing
from qforge.engine.execution.context import AppContext
from qforge.engine.execution.runner import run_raw
from qforge.engine.fidelity import extract_simulation_data

# Event bus (optional, cheap)
from qforge.engine.infrastructure.events import (
    ALL,
    RUN_END,
    RUN_START,
    SWEEP_END,
...
from qforge.engine.infrastructure.logging import event_log_handler

# Typed models
from qforge.engine.models import (
    ArtifactRef,
    CircuitStatistics,
    ExperimentAnalysis,
    ExperimentConfig,
...
# Storage adapter
from qforge.engine.persistence.storage import LocalStorage
from qforge.engine.provenance import build_provenance
from qforge.engine.viz_pipeline import render_visualizations
...
def sweep(
    ...
    if _use_hw_session:
        from qforge.engine.execution.hardware import create_session, resolve_backend
