...
- **HumanFormatter** — readable terminal output::
      ...
      2026-02-20 16:15:03 INFO     qforge.engine.api: Starting experiment

- **JsonFormatter** — one JSON object per line for machine consumption::

      {"ts": "2026-02-20T16:15:03", "level": "INFO",
       "logger": "qforge.engine.api", "msg": "Starting experiment"}
...
if TYPE_CHECKING:
    from qforge.engine.infrastructure.events import Event
...
def event_log_handler(event: Event) -> None:
    ...
    """
    logger = logging.getLogger("qforge.engine.events")
