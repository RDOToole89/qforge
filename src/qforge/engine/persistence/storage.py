...
Notes:
-----
- `ArtifactRef` is imported from qforge.engine.models to keep a single source of truth.
- This module intentionally stays small; richer policies (archival/retention)
  can be layered on top later using your models in src/qforge/engine/models/storage.py.
"""
...
from qforge.engine.models.storage import (
