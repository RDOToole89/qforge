...
Try it:
    from qforge.experiments.basics.noise_comparison import noise_comparison
...
TRY IT:
    from qforge.experiments.basics.deep_dives.dd_noise_model_comparison import noise_comparison
